...
{
    public class DeviceEnergyLimitRepo : IDeviceEnergyLimitRepo
    {

        private readonly ApplicationDbContext _dbContext;
        private readonly DbSet<DeviceEnergyLimit> _dbSet;

        public DeviceEnergyLimitRepo(ApplicationDbContext dbContext)
        {
        ...
        public async Task<IEmunerable<DeviceEnergyLimit>> GetAllDeviceEnergyLimit()
        {
